...
public class SemanticAnalyzer implements AbsynVisitor {
    ...
    @Override
    public void visit(FunctionDec node, int level, boolean flag) {
        ...
        if (node.body instanceof NilExp) {
            ...
            while (params != null && params.head != null) {
                params.head.accept(this, level + 1, flag);
                params = params.tail;
            }

            node.body.accept(this, level + 1, flag);
    ...
    @Override
    public void visit(SimpleDec node, int level, boolean flag) {
    ...
    @Override
    public void visit(ArrayDec node, int level, boolean flag) {
    ...
    @Override
    public void visit(CompoundExp node, int level, boolean flag) {
        ...
        if (firstCompoundInFunction) {
            ...
            enteredScope = true;
            symbolTable.enterScope("Entering compound statement");
        }

        if (node.decs != null) {
            node.decs.accept(this, level, flag);
        }
    ...
    @Override
    public void visit(AssignExp node, int level, boolean flag) {
        String lhsType = null;
        int lhsDim = 0;
        String varName = null;
        ...
        if (node.lhs instanceof VarExp) {
            ...
            if (varExp.variable instanceof SimpleVar) {
                ...
                visit((IndexVar) varExp.variable, level, flag);
        ...
        node.rhs.accept(this, level, flag);
    }
    ...
    @Override
    public void visit(OpExp node, int level, boolean flag) {
    ...
    @Override
    public void visit(CallExp node, int level, boolean flag) {
    ...
    @Override
    public void visit(IfExp node, int level, boolean flag) {
        //system.out.println("[VISIT] IfExp");
		//printer.printLevel("[VISIT] IfExp", level);
    
        node.test.accept(this, level, flag);
        String conditionType = getExpressionType(node.test);
    
        if (!conditionType.equals("bool") && !conditionType.equals("int")) {
            errorOutput = errorOutput + "\n[ERROR] Condition in if-statement must be  'bool' or 'int', but got '" + conditionType + " at line " + (node.row + 1) + " and column " + (node.col + 1);
            errorFlag = true;
        }
    
        node.thenpart.accept(this, level, flag);
        if (node.elsepart != null) {
            node.elsepart.accept(this, level, flag);
        }
    }
    

    @Override
    public void visit(WhileExp node, int level, boolean flag) {
        ...
        node.body.accept(this, level, flag);
    }

    @Override
    public void visit(ReturnExp node, int level, boolean flag) {
        hasReturn = true;
    ...
    @Override
    public void visit(VarExp node, int level, boolean flag) {
    ...
    public void visit(IntExp node, int level, boolean flag) {
        //system.out.println("[VISIT] IntExp");
		//printer.printLevel("[VISIT] IntExp", level);
		
    }

    public void visit(Exp node, int level, boolean flag) {
        //system.out.println("[VISIT] Exp");
		//printer.printLevel("[VISIT] Exp", level);
    }

    public void visit(BoolExp node, int level, boolean flag) {
        //system.out.println("[VISIT] BoolExp");
		//printer.printLevel("[VISIT] BoolExp", level);
    }

    public void visit(WriteExp node, int level, boolean flag) {
        //system.out.println("[VISIT] WriteExp");
		//printer.printLevel("[VISIT] WriteExp", level);
        node.output.accept(this, level, flag);
    }

    public void visit(ReadExp node, int level, boolean flag) {
        //system.out.println("[VISIT] ReadExp");
		//printer.printLevel("[VISIT] ReadExp", level);
        node.input.accept(this, level, flag);
    }

    public void visit(RepeatExp node, int level, boolean flag) {
        //system.out.println("[VISIT] RepeatExp");
		//printer.printLevel("[VISIT] RepeatExp", level);
        node.exps.accept(this, level, flag);
        node.test.accept(this, level, flag);
    }

    @Override
    public void visit(ExpList node, int level, boolean flag) {
    ...
    public void visit(NilExp node, int level, boolean flag) {
    }

    public void visit(VarDecList node, int level, boolean flag) {
    ...
    public void visit(SimpleVar node, int level, boolean flag) {
    ...
    public void visit(NameTy node, int level, boolean flag) {
    ...
    @Override
    public void visit(IndexVar node, int level, boolean flag) {
        SymbolEntry entry = symbolTable.lookup(node.name);
        ...
        node.index.accept(this, level, flag);
    }
